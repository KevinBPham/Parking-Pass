...
as it will vary by device depending on how SQL is set up on your system.  Because session-express is experiencing problems, the unique adminhome.ejs page is only accessible through index.ejs.  Currently, registering a user, registering a pass,
